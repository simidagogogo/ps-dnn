...
def add_user_behavior_dict_1day_global(
    user_behavior_dict_1day_global, userid, date, btag, cate, brand
):
...
def add_user_behavior_dict_1day_global_realtime(
    user_behavior_dict_1day_global_realtime, userid, date, time_stamp, btag, cate, brand):
    if date not in [
        "20170506",
        "20170507",
        "20170508",
    ...
    user_behavior_dict_1day_global_realtime[userid][date][btag]["cate"].append(
        cate_behavior
    )
    user_behavior_dict_1day_global_realtime[userid][date][btag]["brand"].append(
        brand_behavior
    )


def gen_user_behavior_1day_global(
    user_behavior_dict_1day_global, user_behavior_dict_1day_global_realtime
):
    count = 0
    with open("uncompress/behavior_log.csv", "r") as input_data:
        ...
        while line:
            ...
            add_user_behavior_dict_1day_global(
                user_behavior_dict_1day_global, userid, date, btag, cate, brand
            )
            add_user_behavior_dict_1day_global_realtime(
...
def gen_user_behavior_last_14day_global(
    user_behavior_dict_1day_global, user_behavior_dict_last_14day_global
):
    count = 0
    for userid in user_behavior_dict_1day_global:
        ...
        for i in range(14):
            ...
            if past_date in user_behavior_dict_1day_global[userid]:
                merge_dict_3level(
                    temp_user_behavior_dict_last_14day_global,
                    user_behavior_dict_1day_global[userid][past_date],
                )
        user_behavior_dict_last_14day_global[userid][start_date] = copy.deepcopy(
            temp_user_behavior_dict_last_14day_global
        )
        ...
        for date in [
            ...
            if past_15_date in user_behavior_dict_1day_global[userid]:
                cut_dict_3level(
                    temp_user_behavior_dict_last_14day_global,
                    user_behavior_dict_1day_global[userid][past_15_date],
                )
            past_1_date = (
            ...
            if past_1_date in user_behavior_dict_1day_global[userid]:
                merge_dict_3level(
                    temp_user_behavior_dict_last_14day_global,
                    user_behavior_dict_1day_global[userid][past_1_date],
                )
            user_behavior_dict_last_14day_global[userid][date] = copy.deepcopy(
                temp_user_behavior_dict_last_14day_global
            )
        ...
        if count % 10000 == 0:
            print(
                time.strftime("%Y-%m-%d %H:%M:%S", time.localtime()),
                " gen last 14 days user behaviors for  ",
                count,
                " users",
            )
...
def gen_user_feature_last_14day_global(
    user_behavior_dict_last_14day_global, userid, date, action_type, dim, num=50
):
    res = []
    if userid not in user_behavior_dict_last_14day_global:
        return res
    ...
    user_action_dict = user_behavior_dict_last_14day_global[userid][date][action_type][
        dim
    ]
...
def gen_user_feature_global_realtime(
    user_behavior_dict_1day_global_realtime, userid, time_stamp, action_type, dim
):
    latest_n_feas_dict = {}
    latest_n_feas = []
    latest_1_fea = ""
    ...
    user_action_dict = user_behavior_dict_1day_global_realtime[userid][date][
        action_type
    ][dim]
    act_num = len(user_action_dict)
...
if __name__ == "__main__":
    ...
    gen_user_behavior_1day_global(
        user_behavior_dict_1day_global, 
        user_behavior_dict_1day_global_realtime
        )
    gen_user_behavior_last_14day_global(
        user_behavior_dict_1day_global, 
        user_behavior_dict_last_14day_global
        )
    ...
    with open("final_data/user_behavior_last_14day_global", "w+") as f:
        for userid in user_behavior_dict_last_14day_global:
            user_behavior_last_14day_global = user_behavior_dict_last_14day_global[
                userid
            ]
            f.write(userid)
            f.write("\t")
    ...
    print(
        "test pv cate 14days\t",
        gen_user_feature_last_14day_global(
            user_behavior_dict_last_14day_global, "452547", "20170508", "pv", "cate"
        ),
    )
    print(
        "test pv brand 14days\t",
        gen_user_feature_last_14day_global(
            user_behavior_dict_last_14day_global, "452547", "20170508", "pv", "brand"
        ),
    )
    ...
    print(
        "test pv cate realtime\t",
        gen_user_feature_global_realtime(
            user_behavior_dict_1day_global_realtime,
            "452547",
            "1494246535",
            "pv",
